...
export type WordSentenceBuilderRef = {
  showHint: () => void
}
 ...
 * - 게임 레이아웃 구성
 */
export const WordSentenceBuilder = forwardRef<WordSentenceBuilderRef, WordSentenceBuilderProps>(
  ({ sentence, translation, onComplete, onWrong, isCompleted = false, completedWords }, ref) => {
    // 구두점 포함 파싱
...
WordSentenceBuilder.displayName = 'WordSentenceBuilder'
